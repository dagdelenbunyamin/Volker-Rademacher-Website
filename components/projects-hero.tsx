      ...
      <div className="container mx-auto px-4 relative z-10 pt-16">
        ...
        >
          ...
          <p className="text-blue-100 text-lg mb-8">
            Entdecken Sie eine Auswahl unserer erfolgreich abgeschlossenen Projekte. Überzeugen Sie sich von unserer
            Expertise und Qualität in verschiedenen Bereichen der Gebäudetechnik.
          </p>
        </motion.div>
      </div>
    </section>
